...
const PatternBackground: React.FC<PatternBackgroundProps> = ({ children }) => {
  ...
  const patternOpacity = isDark ? 0.20 : 0.15;
            ...
            */}
            ...
            >
              ...
              >
                ...
                />
                <Circle cx="18" cy="20" r="1.5" fill={patternColor} transform="translate(10, 10)" />
                <Circle cx="32" cy="20" r="1.5" fill={patternColor} transform="translate(10, 10)" />

                {/* ICON 2: Earnado Lightning (Top Right) */}
                <Path 
                ...
                <Path d="M10 6 V14 M8 6 H12 M8 14 H12 M8 10 H12" transform="translate(10, 70)" />
                ...
                />
                <Circle cx="8" cy="8" r="1" fill={patternColor} transform="translate(70, 70) scale(1.3)" />
                <Circle cx="12" cy="8" r="1" fill={patternColor} transform="translate(70, 70) scale(1.3)" />
              </G>
            </Pattern>
          </Defs>

          {/* Fill the whole screen with the pattern defined above */}
          <Rect x="0" y="0" width="100%" height="100%" fill="url(#game-pattern)" />
        </Svg>
      </View>
